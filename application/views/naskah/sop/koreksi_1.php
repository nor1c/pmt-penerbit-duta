...
<script>
    ...
    let baseOptions = [
        {
            "label": 1,
            "title": "Format dan layout",
            "checked": false,
            "striked": false,
            "child": [
                {
                    "label": "a.",
                    "title": "Header dan footer sudah ada",
                    "checked": false,
                    "striked": false,
                },
                {
                    "label": "b.",
                    "title": "Jenis dan point font konsisten",
                    "checked": false,
                    "striked": false,
                },
                {
                    "label": "c.",
                    "title": "Bab, subbab, subbabbab sudah sistematis",
                    "checked": false,
                    "striked": false,
                },
                {
                    "label": "d.",
                    "title": "Ikon untuk fitur-fitur konsisten",
                    "checked": false,
                    "striked": false,
                },
                {
                    "label": "e.",
                    "title": "Gambar, foto, dan tabel tersedia lengkap",
                    "checked": false,
                    "striked": false,
                },
            ]
        },
        {
            ...
            "child": [
                {
                    "label": "a.",
                    "title": "Materi dan hal-hal sensitif",
                    "checked": false,
                    "striked": false,
                },
                {
                    "label": "b.",
                    "title": "Persamaan/formulasi/ayat/hadis sudah benar dan tepat",
                    "checked": false,
                    "striked": false,
                },
                {
                    "label": "c.",
                    "title": "Kosakata dan aksara khusus",
                    "checked": false,
                    "striked": false,
                },
                {
                    "label": "d.",
                    "title": "Ketepatan jumlah halaman",
                    "checked": false,
                    "striked": false,
                },
                {
        ...
        {
            "label": "3.",
            "title": "Bedah naskah (editor ahli/konsultan)",
            "checked": false,
            "striked": false,
        },
    ]
    ...
    $(document).ready(function() {
        ...
        saveOrSend = (isSend = false) => {
            ...
            $.ajax({
                url: "<?=site_url('naskah/save_sop_koreksi_1')?>",
                data: data,
                method: "POST",
                success: function () {
                    Swal.fire(
                        'Berhasil menyimpan!',
                        'SOP Koreksi 1 berhasil disimpan..',
                        'success'
                    ).then(function() {
