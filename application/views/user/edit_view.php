<div class="row">
	<div class="col-md-12">
		<h1><button type="button" class="btn btn-danger"> Edit Data Karyawan <span class="badge">></span></button>  </h1>
	...
	<div class="col-md-8">
		<form class="form-horizontal" role="form" method="POST" action="">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" name="no_telepon" id="no_telepon" class="form-control" required="required" placeholder="No Telepon" maxlength="15" value="<?php echo $user['no_telp']; ?>">
				</div> 
				<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="email" name="email" id="email" class="form-contro" required="required" placeholder="mail@example.com" value="<?php echo $user['email']; ?>">
				</div>
				<div class="col-sm-3"></div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="tanggal_masuk" class="form-control date" data-date-format="DD/MM/YYYY" id="tanggal_masuk" placeholder="dd/mm/yyyy" value="<?php echo $this->tanggal->tanggal_indo($user['tanggal_masuk']); ?>">
				</div>
				<div class="col-sm-3"></div>
			</div>
