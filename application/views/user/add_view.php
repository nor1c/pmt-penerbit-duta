<div class="row">
	<div class="col-md-12">
		...
		<h1><button type="button" class="btn btn-primary"> Tambah Data Karyawan <span class="badge">></span></button>  </h1>
	...
	<div class="col-md-8">
		<form class="form-horizontal" role="form" method="POST" action="">
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="user_name" class="form-control" id="user_name" required="required" placeholder="NIK" maxlength="20">
				</div>
				<div class="col-sm-3">
